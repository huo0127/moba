...
// 英雄獲取小符文相關符文列表
export function get_little_first_rune (data) {
  return request({
    url: 'little_first_runes',
    data
  })
}

// 英雄獲取小符文相關符文列表
export function get_little_second_rune (data) {
  return request({
    url: 'little_second_runes',
    data
  })
}

// 英雄獲取小符文相關符文列表
export function get_little_third_rune (data) {
  return request({
    url: 'little_third_runes',
    data
  })
}
